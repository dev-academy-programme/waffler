...
Examples:
  send assignments:
    ...
    e.g.$ wafflepusher push 1-assignments moa-2016 peterjacobson* mypassword12*
  ...
  create sprint labels for cohort repo (once per cohort):
        $ wafflepusher label nil <cohort> <github username*> <github password*>
    e.g.$ wafflepusher label nil moa-2016 peterjacobson mypassword12
